...
class GetData():
    ...
    def _filter_pair(self, drug_cell_df):
        ...
        # not_index = ['DATA.908134', 'DATA.1789883', 'DATA.908120', 'DATA.908442'] #not in index
    ...
    def getRna(self, traindata, testdata):
        data_mistakes = ['908134', '908120',
                         '908442', '1789883']
        train_rnaid = list(traindata['COSMIC_ID'])
        test_rnaid = list(testdata['COSMIC_ID'])
        train_rnaid = ['DATA.'+str(i)
                       for i in train_rnaid if str(i) not in data_mistakes]
        test_rnaid = ['DATA.' + str(i)
                      for i in test_rnaid if str(i) not in data_mistakes]
