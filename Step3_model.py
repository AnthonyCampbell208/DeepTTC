...
class data_process_loader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print(index)
        # print(self.drug_df.shape[0])
        # print(self.rna_df.shape[0])
        # print('\n')
        # pdb.set_trace()
...
class DeepTTC:
    ...
    def train(self, train_drug, train_rna, val_drug, val_rna):
        ...
        training_generator = data.DataLoader(data_process_loader(
            train_rna.index.values, train_drug.Label.values, train_drug, train_rna), **params)
        validation_generator = data.DataLoader(data_process_loader(
            val_rna.index.values, val_drug.Label.values, val_drug, val_rna), **params)
